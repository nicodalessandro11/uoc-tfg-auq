...
import { Database, Settings, Activity, ArrowLeft, LogOut, MapPin, EyeOff } from "lucide-react"
    ...
    <AdminLeaveModalContext.Provider value={{ showLeaveModal, setShowLeaveModal, setPendingNavigation }}>
      <div id="config-root" className="container mx-auto py-4 md:py-8 px-4 space-y-6">
        ...
        <Dialog open={showLeaveModal} onOpenChange={setShowLeaveModal}>
          <DialogContent className="z-[2147483646]">
            <DialogHeader>
              <DialogTitle>Leave Settings?</DialogTitle>
            </DialogHeader>
            <div className="py-2">
              <p>You are about to leave the settings page. Any changes will be applied. Are you sure you want to continue?</p>
            </div>
            <DialogFooter>
